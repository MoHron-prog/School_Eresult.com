...
<!-- Comments Section -->
<div class="comment" style="width: 100%; padding: 10px; border: 1px solid black; display: flex; align-items: center; margin: 0.1in 0;">
    <table style="width: 100%;">
        <tr>
            <td style="width:65%;">
                <span class="label" style="font-weight: bold; text-transform: uppercase; font-size: 14px; white-space: nowrap;">CLASS TEACHER'S COMMENT</span>
                <span class="comment-line" style="border-bottom: 2px dotted #000; width: 100%; height: 20px; display: inline-block; margin-left: 8px;"></span>
            </td>
            <td class="signature-cell" style="text-align: right; white-space: nowrap; width: 35%;">
                <span class="label" style="font-weight: bold; text-transform: uppercase; font-size: 14px; white-space: nowrap;">SIGNATURE</span>
                <span class="signature-line" style="border-bottom: 2px dotted #000; width: 200px; height: 12px; display: inline-block; margin-left: 8px;"></span>
            </td>
        </tr>
        <tr>
            <td>
                <span class="label" style="font-weight: bold; text-transform: uppercase; font-size: 14px; white-space: nowrap;">HEAD TEACHER'S COMMENT</span>
                <span class="comment-line" style="border-bottom: 2px dotted #000; width: 100%; height: 20px; display: inline-block; margin-left: 8px;"></span>
            </td>
            <td class="signature-cell" style="text-align: right; white-space: nowrap; width: 35%;">
                <span class="label" style="font-weight: bold; text-transform: uppercase; font-size: 14px; white-space: nowrap;">SIGNATURE</span>
