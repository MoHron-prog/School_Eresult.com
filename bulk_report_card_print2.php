...
// FIXED: Comment section layout to match image - comments and signatures on same line with dotted lines
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* FIXED: Comments section styling to match image exactly */
        .comments-section {
            margin: 0.1in 0;
            width: 100%;
            border: 1px solid #000;
                    ...
                    ?>
                        ...
                        <div class="report-card-page">
                            <div class="report-card">
                                ...
                                <!-- FIXED: Comments Section - Matches image exactly -->
