...
// MODIFIED: Set A4 page dimensions (8.27in x 11.69in) with 0.5in margins
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Report Card Styles - A4 Portrait with correct dimensions and margins */
        .report-card {
            width: 100%;
            max-width: 8.27in;
            /* A4 width */
                    ...
                    ?>
                        ...
                        <div class="report-card-page">
                            <div class="report-card">
                                ...
                                <div class="text-center font-bold" style="margin: 0.1in 0; font-size: 11pt;">
