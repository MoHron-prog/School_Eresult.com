...
// FIXED: Comment section layout to match image - two comment rows with signatures below side by side
// FIXED: All CSS styles moved to <style> section, no inline styles
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Comments section styling to match image exactly */
        .comments-section {
            margin: 0.1in 0;
            width: 100%;
            border: 1px solid #000;
                    ...
                    ?>
                        ...
                        <div class="report-card-page">
                            <div class="report-card">
                                ...
                                <!-- Comments Section - Matches image exactly with two comment rows and signatures below -->
                                <div class="comments-section">
                                    <!-- Class Teacher Comment Row -->
                                    <div class="comment-row">
                                        <div class="comment-label">CLASS TEACHER'S COMMENT</div>
                                        <div class="comment-content"><?= htmlspecialchars($class_teacher_comment ?: '') ?></div>
                                    </div>
                                    
                                    <!-- Head Teacher Comment Row -->
                                    <div class="comment-row">
                                        <div class="comment-label">HEAD TEACHER'S COMMENT</div>
                                        <div class="comment-content"><?= htmlspecialchars($head_teacher_comment ?: '') ?></div>
                                    </div>
                                </div>

                                <!-- Signatures Row - Side by side -->
